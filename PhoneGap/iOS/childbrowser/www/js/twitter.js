...
var options = {
consumerKey: '7QzOIjxJMGIZZbtM5Yxyig', // YOUR Twitter CONSUMER_KEY
consumerSecret: 'wxcxwj21rMFO2fH0vsfluGdbH4gw2TPwSArmHSA2vZQ', // YOUR Twitter CONSUMER_SECRET
    callbackUrl: "http://londonhackathons.herokuapp.com/" }; // YOU have to replace it on one more Place
...
success:function(loc){
     ...
     */
    if (loc.indexOf("http://londonhackathons.herokuapp.com") >= 0) {
